    ...
    <Container id="footer">
      <Profile>
        ...
        <div className="address">
          ...
          <Slide direction="left">
            <p>Resistencia, Chaco - (dispuesto a reubicación)</p>
          </Slide>
        </div>
        <div className="links">
          <Slide direction="left">
          ...
          <div>
            ...
            <Slide direction="left">
              <a href="tel:+543482624726">+54 3482 62 4726</a>
            </Slide>
          </div>
          <div>
            <Slide direction="left">
            ...
            <Slide>
              <a href="mailto:ramirezj.exequiel@gmail.com">ramirezj.exequiel@gmail.com</a>
            </Slide>
          </div>
        </div>
